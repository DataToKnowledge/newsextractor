...
public class URLCanonicalizer {
	...
	public static String getCanonicalURL(String url) throws MalformedURLException, URISyntaxException {
	...
	public static String getCanonicalURL(String href, String context)
		...
		URL canonicalURL = new URL(UrlResolver.resolveUrl(context == null ? ""
				: context, href));
		 ...
		 * and no segments equal to ".." that are preceded by a segment not
		 * equal to "..".
		 */
