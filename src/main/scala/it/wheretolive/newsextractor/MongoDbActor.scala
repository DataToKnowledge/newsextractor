...
//import it.wheretolive.newsextractor.logic.MongoDbMappings
...
//object MongoDbActor {
//
//  object FindLatestNewsUrl
//
//  case class UrlNews(url: Option[String])
//
...
//
//  import it.wheretolive.newsextractor.MongoDbActor._
...
//          if (list.size == 0) {
//
////            val res = crawledNews.insert(record)
////
////            res pipeTo send
//          }
//          else{
